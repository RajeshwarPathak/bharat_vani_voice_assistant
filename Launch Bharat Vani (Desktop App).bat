...
if exist "%SCRIPT_DIR%bharat-vani" set "APP_DIR=%SCRIPT_DIR%bharat-vani"
...
powershell -NoProfile -ExecutionPolicy Bypass -Command ^
    ...
    "Start-Process -FilePath 'node.exe' -ArgumentList 'dist/server.cjs' -WorkingDirectory '%APP_DIR%' -WindowStyle Hidden; " ^
